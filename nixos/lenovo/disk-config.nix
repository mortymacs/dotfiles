# Declarative disk layout for the Lenovo machine.
#
...
#        sudo nix --experimental-features "nix-command flakes" run github:nix-community/disko -- --mode disko --flake "github:mortymacs/dotfiles#lenovo"
#   3. Install the system:
#        sudo nixos-install --flake "github:mortymacs/dotfiles#lenovo"
#   4. Reboot
#
...
#        sudo nixos-rebuild boot --flake ".#lenovo"
#   4. Reboot
{
  disko.devices = {
    disk = {
