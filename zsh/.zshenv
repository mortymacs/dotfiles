...
export FZF_DEFAULT_OPTS='--inline-info --cycle --tabstop=4 --bind alt-up:preview-half-page-up,alt-down:preview-half-page-down --height ~50% --layout=reverse --preview-window=noborder'
