{
	services.sxhkd = {
		...
		keybindings = {
			...
			# Swap.
			"super + alt + {Left,Down,Up,Right}" = "bspc node -s {west,south,north,east}";
			...
			# -- Move/resize.
			# Resize.
			"super + shift + alt + {Left,Down,Up,Right}" = "bspc node -z {left -20 0,bottom 0 20,top 0 -20,right 20 0}";
