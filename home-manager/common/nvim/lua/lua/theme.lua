...
vim.api.nvim_set_hl(0, "GlancePreviewNormal",      {bg = "#1b1c36"})
vim.api.nvim_set_hl(0, "GlancePreviewMatch",       {bg = "#1b1c36"})
vim.api.nvim_set_hl(0, "GlancePreviewSignColumn",  {bg = "#1b1c36"})
vim.api.nvim_set_hl(0, "GlancePreviewLineNr",      {bg = "#1b1c36"})
vim.api.nvim_set_hl(0, "GlanceListNormal",         {bg = "#1b1c36"})
