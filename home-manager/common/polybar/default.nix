...
let
  ...
  background = "#0f111b";
  foreground = "#ECECEC";
  border-bottom = "#9f86c0";
  disabled = "#413c58";

  # Workspace.
  active-workspace-background = "#2B2D42";
  ...
  # Location.
  main-location-foreground = "#D81E5B";
  second-location-foreground = "#EB5E55";
in
{
  services.polybar =
    {
      ...
      config = {
        ...
        "module/ipc-dunst" = {
          type = "custom/ipc";
          initial = 1;
          hook-0 = "echo \"%{A1:dunstctl set-paused true && polybar-msg hook ipc-dunst 2:}🔔%{A}\" &";
          hook-1 = "echo \"%{A1:dunstctl set-paused false && polybar-msg hook ipc-dunst 1:}%{F#ff2200}🔕%{F-}%{A}\" &";
        };
